...
const Main = () => {
    ...
    async function fetchReport(){
        const messages = [
            {
                role:'system',
                content: `you are an polyglot that convert given text by the user in english and response back the same text in ${radio} language.
                    You don't have to greet them or respond back differently just convert the same text in the required language mentioned by the
                    user.
                `
            },
            {
